...
*/
        ...
        testFieldViewExist("timerTxt","MaterialTextView",activity);
        testFieldViewExist("homeTeamTxt","MaterialTextView",activity);
        testFieldViewExist("awayTeamTxt","MaterialTextView",activity);
        testFieldViewExist("homeScoreTxt","MaterialTextView",activity);
        testFieldViewExist("awayScoreTxt","MaterialTextView",activity);
        ...
        testFieldViewExist("startMatch","MaterialButton",activity);
        testFieldViewExist("finishMatch","MaterialButton",activity);
    }
...
*/
    ...
    public void check_05_StartMatch_Clicked() throws InterruptedException {
        ...
        testViewContent(getViewFromActivity("matchStartBtn",activity),"MaterialButton","Stop");
    ...
    public void check_12_StopMatch_Clicked() {
        ...
        testViewContent(getViewFromActivity("matchStartBtn",activity),"MaterialButton","Start");
    ...
    private void testDataAfterClick(String team, String type, String playerName) {
        ...
        testViewContent(footerTxt,"MaterialTextView","Soccer Last News:");


        String txt = newsType+" for "+teamName+ " by "+playerName+" at "+timeShow;
        testViewContent(newsTxt,"MaterialTextView",txt);
    }
